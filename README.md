...
🧾 Player Data Format
Each player is stored in a text file using this format:
...
- Reset browser-saved changes
Open the Website
🔗 Click here to open the IPL Roster Manager
File	Purpose
...
The terminal application provides the following menu options:
1. View Teams
2. Search a Team
